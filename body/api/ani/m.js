      ...
      other = {
        ...
        myRating: (path, item) => {
          El.Input({
            ...
            onchange: (e) => {
              o.s[name].myRating = e.target.value;
            },
            func: (e) => {
              el[name].myRating = e;
          ...
          chapters: {
            readed: (path, item) => {
              El.Input({
                ...
                onchange: (e) => {
                  o.s[name].readedCh = e.target.value;
                },
                func: (e) => {
                  el[name].readedCh = e;
                  if(e.value) e.style.width = +e.value.length*8+'px';
          ...
          volumes: {
            readed: (path, item) => {
              El.Input({
                ...
                onchange: (e) => {
                  o.s[name].readedVol = e.target.value;
                },
                func: (e) => {
                  el[name].readedVol = e;
                  if(e.value) e.style.width = +e.value.length*8+'px';
